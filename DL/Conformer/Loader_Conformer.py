...
from models.DL.Conformer.Model_Conformer import Conformer
from utils.ModelLoader import ModelLoader
from utils.preprocessing import Preprocessor


class Loader_Conformer(ModelLoader):
    """Conformer loader for classification and regression."""
...
class EEGPreprocessor_Conformer(Preprocessor):
    """Preprocessor for Conformer: default target_fs=250, normalize_method='car', time_length=4; see Preprocessor."""
