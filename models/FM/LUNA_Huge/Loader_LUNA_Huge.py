...
from models.FM.LUNA_Huge.Model_LUNA_Huge import LUNA
...
class Loader_LUNA_Huge(ModelLoader):
    """LUNA_Huge loader with channel-location embeddings."""

    PRETRAINED_FILENAME = 'LUNA_huge.safetensors'
...
class EEGPreprocessor_LUNA_Huge(Preprocessor):
    """Preprocessor for LUNA_Huge: default target_fs=256, bandpass 0.5–50 Hz."""
