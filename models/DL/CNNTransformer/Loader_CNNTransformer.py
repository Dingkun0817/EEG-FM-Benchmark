...
from models.DL.CNNTransformer.Model_CNNTransformer import CNNTransformer
from utils.ModelLoader import ModelLoader
from utils.preprocessing import Preprocessor


class Loader_CNNTransformer(ModelLoader):
    """CNN + Transformer loader for classification and regression."""
    ...
    def __init__(self, eeg_dataset, **kwargs):
        ...
        self.main_model = CNNTransformer(
    ...
    def forward(self, x):
        output = self.main_model.forward(x)
        return output


class EEGPreprocessor_CNNTransformer(Preprocessor):
    """Preprocessor for CNNTransformer: default target_fs=250, normalize_method='car', time_length=4."""
