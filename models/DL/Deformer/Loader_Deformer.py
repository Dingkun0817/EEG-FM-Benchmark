...
from models.DL.Deformer.Model_Deformer import Deformer
from utils.ModelLoader import ModelLoader
from utils.preprocessing import Preprocessor


class Loader_Deformer(ModelLoader):
    """Deformer loader for classification and regression."""
    ...
    def __init__(self, eeg_dataset, **kwargs):
        ...
        self.main_model = Deformer(
            num_chan=self.num_channels,
            num_time=self.num_time_points,
            temporal_kernel=11,
            num_kernel=64,
...
class EEGPreprocessor_Deformer(Preprocessor):
    """Preprocessor for Deformer: default target_fs=250, normalize_method='car', time_length=4."""
