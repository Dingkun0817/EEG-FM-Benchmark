...
def download_data_BNCI2014008():
    dataset = BNCI2014_008()
    datasetname = 'BNCI2014008'
...
if __name__ == "__main__":
    ...
    try:
        ...
        # Download data
        #eeg_data_obj = download_data_BNCI2014008()
        print("Data download complete")

        # Loading data from data directory
        file_path = os.path.join(project_root, 'datasets', 'data', 'BNCI2014008.pkl')
